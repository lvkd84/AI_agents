...
import P2Agents.AstarAgent.MapLocation;
...
public class PlannerAgent extends Agent {
    ...
    private Stack<StripsAction> AstarSearch(GameState startState) {
        ...
        PriorityQueue<GameState> frontier = new PriorityQueue<GameState>(1, funcValComparator);
            ...
            if (current.isGoal()) {
                ...
                for (GameState child : children) {
                    if (closedList.containsKey(child.hashCode())) {
                    	...
                    	// based on my findings we don't really need this section; however,
                    // I want to change the heuristic first to see if that would have a greater effect in distinguishing the difference between this including this section of code.
                    else {
     ...
     */
    public static Comparator<GameState> funcValComparator = new Comparator<GameState>() {

			@Override
			public int compare(GameState gs1, GameState gs2) {
				return (int)(gs1.compareTo(gs2));
			}
